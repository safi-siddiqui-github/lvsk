export default function GoogleSvg({ addClasses }: { addClasses?: string }) {
    return (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={`size-5 ${addClasses}`}>
