...
export default function Page() {
    const { setData, data, reset, post, errors, clearErrors, processing } = useForm<Required<PasswordResetForm>>({
        email: '',
    });
    ...
    return (
        <>
            <Head title="Password Forgot"></Head>
            <AuthLayout>
                <form
                ...
                >
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-wrap items-center gap-1">
                            ...
                            <EmphasizeText>password forgot</EmphasizeText>
                        </div>

                        <NormalText>Reset password using your email</NormalText>
                    </div>
